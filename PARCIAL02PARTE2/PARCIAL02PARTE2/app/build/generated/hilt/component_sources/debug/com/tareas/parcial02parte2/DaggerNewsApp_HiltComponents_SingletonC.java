...
import com.tareas.parcial02parte2.di.AppModule_ProvideNewsApiFactory;
import com.tareas.parcial02parte2.di.AppModule_ProvideNewsRepositoryFactory;
import com.tareas.parcial02parte2.di.AppModule_ProvideOkHttpClientFactory;
...
import com.tareas.parcial02parte2.ui.viewmodel.NewsViewModel;
...
public final class DaggerNewsApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends NewsApp_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(Collections.<String, Boolean>singletonMap(LazyClassKeyProvider.com_tareas_parcial02parte2_ui_viewmodel_NewsViewModel, NewsViewModel_HiltModules.KeyModule.provide()));
    }
    ...
    private static final class LazyClassKeyProvider {
      static String com_tareas_parcial02parte2_ui_viewmodel_NewsViewModel = "com.tareas.parcial02parte2.ui.viewmodel.NewsViewModel";

      @KeepFieldType
      NewsViewModel com_tareas_parcial02parte2_ui_viewmodel_NewsViewModel2;
    }
  }
  ...
  private static final class ViewModelCImpl extends NewsApp_HiltComponents.ViewModelC {
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(Collections.<String, javax.inject.Provider<ViewModel>>singletonMap(LazyClassKeyProvider.com_tareas_parcial02parte2_ui_viewmodel_NewsViewModel, ((Provider) newsViewModelProvider)));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.tareas.parcial02parte2.ui.viewmodel.NewsViewModel 
          return (T) new NewsViewModel(viewModelCImpl.getTopHeadlinesUseCase());
  ...
  private static final class SingletonCImpl extends NewsApp_HiltComponents.SingletonC {
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.tareas.parcial02parte2.domain.repository.NewsRepository 
          return (T) AppModule_ProvideNewsRepositoryFactory.provideNewsRepository(singletonCImpl.provideNewsApiProvider.get());

          case 1: // com.tareas.parcial02parte2.data.remote.api.NewsApi 
          return (T) AppModule_ProvideNewsApiFactory.provideNewsApi(singletonCImpl.provideOkHttpClientProvider.get());
